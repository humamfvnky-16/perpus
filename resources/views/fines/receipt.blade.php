...
<div class="card max-w-md mx-auto">
    ...
    <dl class="text-sm space-y-1">
        <div class="flex justify-between"><dt class="text-slate-500 dark:text-slate-400">Anggota</dt><dd class="text-slate-800 dark:text-slate-100">{{ $fine->user?->name }}</dd></div>
