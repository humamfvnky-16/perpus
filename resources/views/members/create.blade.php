...
<form method="POST" action="{{ route('members.store') }}" class="card grid md:grid-cols-2 gap-4">@csrf
    ...
    <div class="md:col-span-2 flex gap-2"><button class="btn-primary">Simpan</button><a href="{{ route('members.index') }}" class="btn-secondary">Batal</a></div>
</form>
@endsection
