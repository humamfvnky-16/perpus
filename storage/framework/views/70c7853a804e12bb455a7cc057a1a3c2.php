...
<div class="min-h-screen flex items-center justify-center p-4 md:p-8 bg-slate-50 dark:bg-slate-900">
    <div class="w-full max-w-md">
        ...
        <p class="text-slate-500 mb-6">Masuk pakai NISN &amp; password .</p>

        <?php if($errors->any()): ?>
        <div class="badge-red mb-4 block py-2 px-3"><i class="fas fa-exclamation-circle"></i> <?php echo e($errors->first()); ?></div>
        <?php endif; ?>

        <form method="POST" action="<?php echo e(route('login.siswa')); ?>" class="space-y-4"><?php echo csrf_field(); ?>
            <div>
                ...
                <div class="relative mt-1">
                    ...
                    <input type="text" name="nisn" value="<?php echo e(old('nisn')); ?>" required autofocus
        ...
        <p class="text-center text-sm mt-6">Bukan siswa?
            <a href="<?php echo e(route('login')); ?>" class="text-primary-600 font-semibold hover:underline">Login dengan email</a>
        </p>
    </div>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\web\Perpus\resources\views/auth/login-siswa.blade.php ENDPATH**/ ?>