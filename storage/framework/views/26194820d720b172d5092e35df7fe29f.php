...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6">
    <div class="card md:col-span-1">
        ...
        <div class="space-y-2 text-sm">
            ...
            <div class="flex justify-between items-center"><span class="text-slate-500 dark:text-slate-400">Tersedia</span><span class="badge-green"><?php echo e($book->available); ?>/<?php echo e($book->stock); ?></span></div>
        </div>
