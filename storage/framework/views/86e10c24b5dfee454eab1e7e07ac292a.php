...
<div class="min-h-screen flex items-center justify-center p-4 md:p-8 bg-slate-50 dark:bg-slate-900">
    <div class="w-full max-w-md">
        ...
        <form method="POST" action="<?php echo e(route('login.guru')); ?>" class="space-y-4"><?php echo csrf_field(); ?>
            <div>
                ...
                <div class="relative mt-1">
                    ...
                    <input type="text" name="nip" value="<?php echo e(old('nip')); ?>" required autofocus
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\web\Perpus\resources\views/auth/login-guru.blade.php ENDPATH**/ ?>